            ...
            <div class="login-container">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon-wrapper">
                        <asp:TextBox ID="txtEmail" runat="server" CssClass="form-input" placeholder="admin@system.com">
                        </asp:TextBox>
                ...
                <asp:Button ID="btnLogin" runat="server" CssClass="btn-auth" Text="ESTABLISH CONNECTION"
                    OnClick="btnLogin_Click" />

                <div style="text-align:center; margin-top:25px;">
                    <a href="../index.aspx"
                        style="color:#64748b; font-size:0.8rem; text-decoration:none; transition:0.3s;"><i
                            class="fas fa-arrow-left"></i> Return to Public Sphere</a>
                </div>
            </div>
        </form>
    </body>
