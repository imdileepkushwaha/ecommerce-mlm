<%@ Page Title="KYC Audit Verification" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeFile="ViewSellerKyc.aspx.cs" Inherits="ecommerce_mlm.admin.ViewSellerKyc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="u-mb-30 u-d-flex u-j-between u-a-center">
        <div>
            ...
            <p class="u-txt-subtitle u-mt-5">Review legal business documents and approve bank clearing settlements.</p>
        </div>
        <div>
            <a href="ManageSellers.aspx" class="badge" style="background:#64748b; padding:10px 16px; text-decoration:none; border-radius:8px; font-weight:700; color:#fff;">
    ...
    <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 25px;">
        ...
        <div>
            ...
            <div class="table-card u-mb-25" style="padding: 30px;">
                <div style="border-bottom:1.5px solid #f1f5f9; padding-bottom:15px; margin-bottom:20px; display:flex; justify-content:space-between; align-items:center;">
                ...
                <table class="admin-table" style="border:none;">
                    <tr>
                        <td style="font-weight:700; color:#64748b; width:30%; padding:12px 0;">Legal Business Name</td>
                        <td style="font-weight:600; color:#0f172a; padding:12px 0;"><asp:Literal ID="litStoreName" runat="server"></asp:Literal></td>
                    </tr>
                    <tr>
                        <td style="font-weight:700; color:#64748b; padding:12px 0;">GST Number</td>
                        <td style="font-weight:600; color:#0f172a; padding:12px 0; display:flex; justify-content:space-between; align-items:center;">
                            <asp:Literal ID="litGst" runat="server">Not Available</asp:Literal>
                            <a id="lnkPopGst" runat="server" visible="false" class="btn-doc-preview" href="javascript:void(0);" onclick="showAuditDoc(this, 'GST Certificate Audit')">
                    ...
                    <tr>
                        ...
                        <td style="font-weight:600; color:#0f172a; padding:12px 0; display:flex; justify-content:space-between; align-items:center;">
                            ...
                            <a id="lnkPopPan" runat="server" visible="false" class="btn-doc-preview" href="javascript:void(0);" onclick="showAuditDoc(this, 'PAN Card Document Audit')">
                    ...
                    <tr>
                        ...
                        <td style="font-weight:600; color:#0f172a; padding:12px 0; display:flex; justify-content:space-between; align-items:center;">
                            ...
                            <a id="lnkPopAadhar" runat="server" visible="false" class="btn-doc-preview" href="javascript:void(0);" onclick="showAuditDoc(this, 'Aadhaar Card Document Audit')">
                                <i class="fas fa-eye"></i> View Card
                            </a>
                        </td>
                    </tr>
            ...
            <div class="table-card u-mb-25" style="padding: 30px;">
                ...
                <table class="admin-table" style="border:none;">
                    <tr>
                        ...
                        <td style="font-weight:600; color:#0f172a; padding:12px 0;"><asp:Literal ID="litBankName" runat="server"></asp:Literal></td>
                    </tr>
                    <tr>
                        <td style="font-weight:700; color:#64748b; padding:12px 0;">Account Holder Name</td>
                        <td style="font-weight:600; color:#0f172a; padding:12px 0;"><asp:Literal ID="litBankHolder" runat="server"></asp:Literal></td>
                    </tr>
                    <tr>
                        <td style="font-weight:700; color:#64748b; padding:12px 0;">Account Number</td>
                        <td style="font-weight:600; color:#0f172a; padding:12px 0;"><asp:Literal ID="litBankAccNo" runat="server"></asp:Literal></td>
                    </tr>
                    <tr>
                        <td style="font-weight:700; color:#64748b; padding:12px 0;">Bank IFSC</td>
                        <td style="font-weight:600; color:#0f172a; padding:12px 0;"><asp:Literal ID="litBankIfsc" runat="server"></asp:Literal></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="table-card" style="padding: 30px;">
                <div style="border-bottom:1.5px solid #f1f5f9; padding-bottom:15px; margin-bottom:20px;">
                    <h3 style="font-size:1.2rem; font-weight:800; color:#0f172a;">📍 Operating Footprint Address</h3>
                </div>
                <p style="font-weight:600; font-size:1rem; color:#0f172a; line-height:1.6;">
                    ...
                    <asp:Literal ID="litState" runat="server"></asp:Literal> - <asp:Literal ID="litPincode" runat="server"></asp:Literal>
                </p>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="table-card" style="padding: 25px; background: #f8fafc;">
                ...
                <p style="font-size:0.8rem; color:#64748b; line-height:1.4; margin-bottom:20px;">Approval will enable active selling operations, inventory creations and payouts clearance.</p>

                <div style="display:flex; flex-direction:column; gap:12px;">
                    <asp:Button ID="btnApprove" runat="server" CssClass="badge" style="border:none; cursor:pointer; font-weight:800; background:#22c55e; color:#fff; padding:14px;" Text="✓ Approve Verification" OnClick="btnApprove_Click" OnClientClick="return confirm('Conform operational verification for this partner portfolio?');" />
                    <asp:Button ID="btnReject" runat="server" CssClass="badge" style="border:none; cursor:pointer; font-weight:800; background:#ef4444; color:#fff; padding:14px;" Text="✗ Reject Submission" OnClick="btnReject_Click" OnClientClick="return confirm('Reject this KYC portfolio? Merchant will receive modification alerts.');" />
                </div>
            </div>
        </div>
